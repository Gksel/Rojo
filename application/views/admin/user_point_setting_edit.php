			...
			<tr>
				...
				<td align="left">
					<?php if($pointsetting_id == 1){?>
						<div style="float:left;margin-right:5px;margin-top:4px;">&yen;100 = </div>
					...
					<?php }else if($pointsetting_id == 3){?>
						<div style="float:left;margin-right:5px;margin-top:4px;">&yen;100 <?php if($this->langtype == '_ch'){echo '积分';}else {echo 'Points';}?> = </div>
						<div style="float:left;margin-left:5px;margin-top:4px;">&yen;</div>
						<input type="text" name="pointsetting_value" style="width:40px" value="<?php echo $pointsetting_value * 100?>"/> 
						<div class="tipsgroupbox"><div class="request">*</div></div>
					<?php }?>
