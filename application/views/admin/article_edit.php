...
<form method="post">
	<table class="gksel_normal_tabpost">
		<tr>
			...
			<td>
				<div class="img_gksel_show" id="img1_gksel_show">
					<?php 
						$img1_gksel = '';
						if(file_exists($articleinfo['article_pic']) && $articleinfo['article_pic']!=""){
							$img1_gksel = $articleinfo['article_pic'];
							echo '<img style="float:left;max-width:400px;max-height:400px;" src="'.base_url().$articleinfo['article_pic'].'" />';
						}
					?>
				</div>
		...
		<tr>
			...
			<td align="left">
				<input type="text" name="article_name_en" style="width:300px;" value="<?php echo $articleinfo['article_name_en']?>"/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" name="article_name_ch" style="width:300px;" value="<?php echo $articleinfo['article_name_ch']?>"/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<input type="text" name="article_url" style="width:400px;" value="<?php echo $articleinfo['article_url']?>"/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left" style="padding-top:10px;">
				<div class="choosecategoryarea" style="float:left;">
					<?php 
						$sql = "SELECT * FROM ".DB_PRE()."article_category WHERE article_id = ".$articleinfo['article_id'];
		...
		<tr style="display:none;">
		    ...
		    <td align="left">
		    	<div style="float:left;width:800px;">
		    		<textarea id="article_content_en" name="article_content_en"><?php echo $articleinfo['article_content_en']?></textarea>
		    	</div>
		    	<div class="tipsgroupbox"><div class="request">*</div></div>
		    </td>
	    </tr>
	    <tr style="display:none;">
		    ...
		    <td align="left">
		    	<div style="float:left;width:800px;">
		    		<textarea style="float:left;" id="article_content_ch" name="article_content_ch"><?php echo $articleinfo['article_content_ch']?></textarea>
		    	</div>
		    	<div class="tipsgroupbox"><div class="request">*</div></div>
		    </td>
	    </tr>
	    <tr style="display:none;">
			...
			<td align="left" style="padding-top:10px;">
				<div class="choosekeywordarea" style="float:left;">
					<?php 
						$sql = "SELECT * FROM ".DB_PRE()."article_keyword WHERE article_id = ".$articleinfo['article_id'];
						$checkres = $this->db->query($sql)->result_array();
		...
		<tr>
			...
			<td align="left">
				<div class="gksel_btn_action_on" onclick="tosave_articleinfo(<?php echo $articleinfo['article_id']?>)"><?php echo lang('cy_save')?></div>
			</td>
		</tr>
	</table>
</form>
