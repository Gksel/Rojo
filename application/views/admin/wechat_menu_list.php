	...
	<tr>
		<td>
			<div class="searcharea">
				<a href="<?php echo base_url().'index.php/wx_sample/createmenu'?>" target="_blank"><font class="nav_on"><?php if($this->langtype == '_ch'){echo '发布微信菜单';}else{echo 'Post Wechat Menu';}?></font></a>
			</div>
		</td>
	</tr>
</table>
