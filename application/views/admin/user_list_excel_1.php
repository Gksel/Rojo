<?php 
	...
	header("Content-Disposition: attachment;filename=userlist_".date('Y-m-d').".xls ");
	...
	echo '<html xmlns:o="urn:schemas-microsoft-com:office:office"
		...
		<div id="Classeur1_16681" align=center x:publishsource="Excel">
			<table x:str border=0 cellpadding=0 cellspacing=0 style="font-family: Calibri, Helvetica, SimSun, sans-serif;border-collapse: collapse;">
				<tr>
					<th height="50" style="font-size:20px;border:.5pt solid windowtext;" colspan="14" align="center" class="xl2216681 nowrap">User List</th>
				</tr>
				<tr>
					...
					<th style="min-height:30px;border:.5pt solid windowtext;background:#111d35;" align="center" class="xl2216681 nowrap">Profile</th>
				...
				if(!empty($userlist)){for($i=0;$i<count($userlist);$i++){
					...
					echo '<td style="min-height:30px;border:.5pt solid windowtext;background:#EFEFEF;" align="center" class="xl2216681 nowrap">'.$userlist[$i]['user_profile'].'</td>';
