...
<body>
	<div class="title">
     <img src="<?php echo base_url()?>RO/header.png">
	</div>
<div class="gksel_ro">

      <div class="gksel_shopping">
       
        <div class="gksel_shopping_section">
	          <p class="header">Jacket length(Front)</p>
	          <p class="header">夹克长(前边)</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
	              <div>
	                 <span>西服</span> <input text="type">
	              </div>
	              <div>
	                 <span>衬衫</span> <input text="type">
	              </div>
	              <div>
	                 <span>马甲</span> <input text="type">
	              </div>
              </div>
        </div> 

   <!--      <div class="gksel_shopping_section">
	         <p class="header">Shoulder width</p>
	         <p class="header">肩宽</p>
	          <div class="input2">
	              <div>
	                 <input type="radio"><span>斜</span>
	                 <input type="radio"><span>平</span>
	                 <input type="radio"><span>冲</span>
	              </div>
	          <div>
	    </div> -->
        <div class="gksel_shopping_section">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Chest circumference</p>
	          <p class="header">夹克胸围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Stomach bust</p>
	          <p class="header">夹克腰围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
...
<!-- 第二个 -->
	<div class="gksel_shopping">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Jacket circumference</p>
	          <p class="header">夹克臀围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Sleeve length</p>
	          <p class="header">夹克袖长</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Arm-Hole Loop</p>
	          <p class="header">臂圈</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Bicep circumference</p>
	          <p class="header">袖肥</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
...
<!-- 第三个 -->
	<div class="gksel_shopping">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Wrist circumference</p>
	          <p class="header">袖口</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Neck circumference</p>
	          <p class="header">领围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Outside leg length</p>
	          <p class="header">裤子长</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Waist measurement</p>
	          <p class="header">裤子腰围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Gluteus circumference</p>
	          <p class="header">臀围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	...
	<div class="gksel_shopping">
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Thigh circumference</p>
	          <p class="header">大腿围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Crotch rise</p>
	          <p class="header">直裆长</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Hamstring circumference</p>
	          <p class="header">中裆围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Calf circumference</p>
	          <p class="header">小腿围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
        ...
        <div class="gksel_shopping_section">
	          <p class="header">Ankle circumference</p>
	          <p class="header">脚口围</p>
	          <div class="input">
	              <div>
	                 <span>身体</span> <input text="type">
	              </div>
...
<!-- 1 -->
 <div class="gksel_show">
       ...
       <div class="gksel_show_section">
         <p>Slim (合体)</p>
         <div><img src="<?php echo base_url()?>RO/show1.jpg"></div>
          <input type="radio" name="max">
       </div>

       <div class="gksel_show_section">
         <p>Slim (合体)</p>
         <div><img src="<?php echo base_url()?>RO/show2.jpg"></div>
          <input type="radio" name="max">
       </div>
  ...
  <div class="gksel_show_2">
       ...
       <div class="gksel_show_section" style="width:100%">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show3.jpg"></div>
...
<!-- 3 -->
   <div class="gksel_show_2">
       ...
       <div class="gksel_show_section" style="width:100%">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show4.jpg"></div>
...
<!-- 4 -->
   <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show5.jpg"></div>
...
<!-- 5 -->
   <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show6.png"></div>
   ...
   <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show7.png"></div>
   ...
   <div class="gksel_show_2" style="margin-bottom:60px;">
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show7_2.png"></div>
   ...
   <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show8.jpg"></div>
   ...
   <div class="gksel_show_2" style="margin-bottom:60px;">
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show8_2.jpg"></div>
...
<!-- 9.1 -->
   ...
   <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show9.png"></div>
   ...
   <!-- 9.2 -->
    <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show9_2.png"></div>
   ...
   <!-- 9.3 -->
    <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show9_3.png"></div>
   ...
   <!-- 9.4 -->
    <div class="gksel_show_2" style="margin-bottom:60px;">
       ...
       <div class="gksel_show_section" style="width:100%;overflow:hidden;">
         ...
         <div>
          <img src="<?php echo base_url()?>RO/show9_4.png"></div>
