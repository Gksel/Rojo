...
<form method="post">
	<table class="gksel_normal_tabpost">
		<tr>
			<td align="right" width="150"><?php echo lang('dz_product_factory_name')?> (English)</td>
			<td align="left">
				<input type="text" name="factory_name_en" value="<?php echo $factoryinfo['factory_name_en']?>"/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			<td align="right" width="150"><?php echo lang('dz_product_factory_name')?> (中文)</td>
			<td align="left">
				<input type="text" name="factory_name_ch" value="<?php echo $factoryinfo['factory_name_ch']?>"/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<div class="gksel_btn_action_on" onclick="tosave_productfactoryinfo(<?php echo $factoryinfo['factory_id']?>)"><?php echo lang('cy_save')?></div>
			</td>
		</tr>
	</table>
</form>
