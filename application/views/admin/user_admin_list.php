...
<?php if($admin_type == 2){?>
	...
	<table class="gksel_normal_tabaction">
		<tr>
			<td>
				<div class="searcharea">
					<a href="<?php echo base_url().'index.php/admins/user/toadd_adminassistant/'.$admin_type.'?backurl='.$current_url_encode?>"><font class="nav_on"><img class="plus" src="<?php echo base_url().'themes/default/images/plus.png'?>"/> <?php echo lang('cy_admin_assistant_add');?></font></a>
					<div onclick="javascript:location.href='<?php echo base_url().'index.php/admins/user/adminassistantlist?admin_type='.$admin_type.'&keyword='.$keyword.'&is_excel=1'?>';" style="float: left;margin-top:7px;cursor:pointer;">
