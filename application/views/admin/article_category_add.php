...
<form method="post">
	<table class="gksel_normal_tabpost">
		<tr>
			...
			<td align="left">
				<input type="text" name="category_name_en" value=""/>
		...
		<tr>
			...
			<td align="left">
				<input type="text" name="category_name_ch" value=""/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<div class="gksel_btn_action_on" onclick="toadd_article_categoryinfo()"><?php echo lang('cy_save')?></div>
			</td>
		</tr>
	</table>
</form>
