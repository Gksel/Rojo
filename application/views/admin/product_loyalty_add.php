...
<form method="post">
	<table class="gksel_normal_tabpost">
		...
		<tr>
			...
			<td align="left">
				<input type="text" name="loyalty_name_en" value=""/>
		...
		<tr>
			...
			<td align="left">
				<input type="text" name="loyalty_name_ch" value=""/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left">
				<textarea name="loyalty_description_en"></textarea>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<textarea name="loyalty_description_ch"></textarea>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<div class="gksel_btn_action_on" onclick="toadd_loyaltyinfo()"><?php echo lang('cy_save')?></div>
			</td>
		</tr>
	</table>
</form>
