			...
			<tbody>
					<tr>
						...
						<td width="100" align="center">
							<?php if($picturelist[$i]['picture_pic']!=""){?>
								<img style="max-width:70px;max-height: 70px;" src="<?php echo CDN_URL().$picturelist[$i]['picture_pic']?>"/>
							<?php }else{?>
						...
						<td width="200" align="center">
							<div style="float:right;">
								<?php 
									...
									echo '<a onclick="todel_productpicture('.$picturelist[$i]['product_id'].', \''.$picturelist[$i]['picture_name_en'].'\')" href="javascript:;" class="gksel_btn_action_on">'.lang('cy_delete').'</a>';
								?>
							</div>
						</td>
					</tr>
...
<table class="gksel_normal_tabactionlist">
	<thead>
		<tr>
			<td colspan="9" style="padding:15px 15px;color:#111d35;font-size:16px;">
