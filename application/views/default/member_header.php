...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>themes/default/member.css?date=<?php echo CACHE_USETIME()?>" />
		...
		<script src="<?php echo base_url()?>themes/default/js/front/base_member.js?date=<?php echo CACHE_USETIME()?>"></script>
